...
soft_c = [Not(y1), Not(y2), Not(y3)]
solver.add_soft(soft_c, id='num_servers')
solver.add_soft(soft_c[0], weight=10, id='costs')
solver.add_soft(soft_c[1], weight=5, id='costs')
solver.add_soft(soft_c[2], weight=20, id='costs')
